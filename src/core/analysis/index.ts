import type { AnomalyResult, ClusterResult } from '../types/analysis'
import { cosineDistance, cosineSimilarity, l2Distance } from '../math/cosineSimilarity'
...
export function scoreAnomalies(embeddings: Float32Array[], logIds: number[]): AnomalyResult[] {
...
export function kMeansPlusPlus(embeddings: Float32Array[], k: number): Float32Array[] {
  const n = embeddings.length
...
export function extractLabel(messages: string[]): string {
